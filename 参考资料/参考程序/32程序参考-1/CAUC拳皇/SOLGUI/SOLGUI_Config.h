...
/*---------用户需根据系统按键返回的键值来进行设定---------*/
#include "key.h"
#define	SOLGUI_KEY_UP			K_UP			//上
#define SOLGUI_KEY_DOWN			K_DOWN			//下
#define	SOLGUI_KEY_LEFT			K_LEFT			//左
#define SOLGUI_KEY_RIGHT		K_RIGHT			//右
#define SOLGUI_KEY_OK			K_OK 			//确认
#define	SOLGUI_KEY_BACK			K_BACK			//返回
